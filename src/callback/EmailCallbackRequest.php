 ...
 */
class EmailCallbackRequest extends CallbackRequest
{
    /** @var string уникальный номер письма в Roistat ("111") */
    public $id;

    /** @var string уникальный номер письма в вашей почте ("222") */
    public $emailId;

    /** @var string номер визита ("123456") */
    public $visitId;

    /** @var string тема письма ("Re: Test") */
    public $subject;

    /** @var string текст письма ("Тестовое письмо") */
    public $text;

    /** @var string email, с которого было отправлено письмо ("email_1@mail.com") */
    public $emailFrom;

    /** @var string email, на который было отправлено письмо ("email+123456@mail.com") */
    public $emailTo;

    /** @var ?array вложенные файлы */
    public $attachments;
